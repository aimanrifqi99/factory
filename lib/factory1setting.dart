...
import 'package:lab05/factory2setting.dart';

class Factory1setting extends StatelessWidget {
  const Factory1setting({Key? key});
      ...
      child: ElevatedButton(
        onPressed: () {
          if (factory == 'Factory 2') {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => Factory2setting()), // Replace AnotherPage() with the desired page widget
            );
          }
        },
        style: ElevatedButton.styleFrom(
